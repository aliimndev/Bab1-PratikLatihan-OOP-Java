...
## Bab 1 – Praktik Object Oriented Programming Java

| No | Folder / Study Case     | Konsep Utama                          | Apa yang Dipelajari                                                                 |
|----|--------------------------|----------------------------------------|--------------------------------------------------------------------------------------|
| 1  | Class                    | Class sebagai cetak biru              | Definisi class, atribut, constructor, method                                         |
...
2. Buka terminal / command prompt di folder root (`oop/`)
3. Compile dan jalankan contoh per folder, contoh:

   ```bash
   # Contoh di folder Class
   cd Class
   javac *.java
   java ClassDemo